insert into Previsao(id, dia_semana, temperatura_min, temperatura_max, humidade_ar, descricao) values (1, 'Segunda', 32.3, 20.6, 39.0, 'dia ensolarado');
insert into Previsao(id, dia_semana, temperatura_min, temperatura_max, humidade_ar, descricao) values (2, 'Terça', 25,9, 15.7, 86.56, '');
